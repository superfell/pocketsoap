...
// SerializerNull.h : Declaration of the CSerializerNull

#ifndef __SERIALIZERNULL_H_
#define __SERIALIZERNULL_H_
...
// CSerializerNull
/////////////////////////////////////////////////////////////////////////////
class ATL_NO_VTABLE CSerializerNull : 
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CSerializerNull, &CLSID_CoSerializerNull>,
	public ISoapDeSerializer,
	public ITypesInit
{
public:

DECLARE_REGISTRY_RESOURCEID(IDR_SERIALIZERNULL)
DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CSerializerNull)
...
private:
	...
	CComVariant			m_nullVal ;
};

#endif //__SERIALIZERNULL_H_
