...
/////////////////////////////////////////////////////////////////////////////
// Copyright (c) 2000-2002, Sells Brothers, Inc.
...
// History:
//  4/3/02:
//  -Fixed inconsistent Usage signatures causing RestrictedValueArg to
//   show the wrong usage. Thanks XavierVergisFarrers [xverges@yahoo.com]!
//
//  8/17/01:
...
public:
    ...
    virtual tstring Logo() const
    {
        ...
        sVersion   = SearchAndReplace(sVersion,   __T(", "),    __T(".")  );
