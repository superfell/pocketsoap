...
<%
' $Header: c:/cvs/pocketsoap/pocketsoap/unitTests-com/server/echo.asp,v 1.1 2003/05/17 23:26:04 simon Exp $
'
...
if request.ServerVariables("REQUEST_METHOD") <> "POST" then
	...
	if ucase(trim(request.ServerVariables("QUERY_STRING"))) = "WSDL" then
		...
		// response.write tx.TransformMemFile ( oWSDLGen.Generate ( oConfFactory, BuildURL() ), "g:\soap_src\simonfell\4s4c\wsdl_xslt\wsdl.xslt" )
		response.end
	end if
end if
